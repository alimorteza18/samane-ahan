...
export default function TypesHorizontal(props: TypeHorizontall) {
  const { autoScrollTop = true, className } = props;
  ...
  return (
    <Container className={className}>
      <div className="type-list ">
        <Swiper
          className="custom-class d-flex justify-content-center"
        ...
        >
          {Object.keys(PRODUCT_TYPE_DETAILS).map((typeId: any) => (
            <SwiperSlide>
              <div
                className="d-flex justify-content-center product-type-btn float-right"
